...
public class ActionQuitter extends AbstractAction implements ActionListener
{
	private static final long serialVersionUID = 1L;
	
	private FeuilleFour feuilleFour;

	public ActionQuitter(String menu, String icone, String aide, int clavier, FeuilleFour feuilleFour) 
	{
